...
// função auxiliar para repetir uma string por N vezes
...
struct DiagnosticOptions
{
    ...
    bool highlightTokens = true; // ainda não existe
}
...
public:
    ...
    string formatDiagnostic(const Diagnostic diagnostic)
    {
        ...
        string severityText = severity == DiagnosticSeverity.ERROR ? "erro" : "aviso";
